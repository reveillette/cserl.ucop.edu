	    ...
	    obj.init = function () {		
			...
			// ADD CONTENT LAYOUT
				...
				if ($('body').hasClass('page-node-add')) {  // only perform on Add Content page(s)
	                                var notice = "<p>It is your responsibility to insure that you have all necessary copyright permissions to upload this content to this site.  You should keep copyright issues in mind when you set the permissions below.</p>";
					$(notice).insertBefore('.node-type-list');
